  	...
  	<div class="container">
    	...
    	<div class="footercredits clearfix">
        	...
        	<?php if(!empty($pinnacle['footer_text'])) { 
             ...
             <a class="revoke-cookies" href="#" onclick="document.cookie='cookiebar=;expires=Thu, 01 Jan 1970 00:00:01 GMT;path=/'; setupCookieBar(); return false;">Cookie Zustimmung widerrufen</a>
    	</div><!-- credits -->
    </div><!-- container -->
</footer>
<?php wp_footer(); ?>